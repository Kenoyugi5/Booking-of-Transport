...
def send_teacher_notification(booking):
    if booking.teacher and booking.teacher.email:
        ...
        # Handle the case where the teacher or their email is not available
        print("No teacher or teacher email available for this booking.")